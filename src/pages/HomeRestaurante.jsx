...
const HomeRestaurante = () => {
    ...
    const buscarDados = async () => {
        const response = await axios.get("https://api.dev-diegodtsa.com.br/restaurante/pedidos/", {
            headers: {
    ...
    const confirmar = async (id) => {
        try {
            await axios.put("https://api.dev-diegodtsa.com.br/restaurante/pedidos/" + id, {
                status: 2
            }, {
                headers: {
                    "Authorization": localStorage.getItem("token")
