...
const ListarMeuRestaurante = () => {
  ...
  const buscarDados = async () => {
    try {
      const response = await axios.get('https://api.dev-diegodtsa.com.br/restaurantes', {
        headers: {
            ...
            (<Grid item xs={12} md={3}>
              <Card>
                ...
                <CardMedia
                  component="img"
                  height="200"
                  image={ "https://api.dev-diegodtsa.com.br/" + restaurante.logo?.replace("public", "") }
                />
                <CardActions>
                  ...
                  <Button color="error" variant='contained' onClick={() => {
                    if (window.confirm("Tem certeza?")) {
                        axios.delete("https://api.dev-diegodtsa.com.br/restaurantes/" + restaurante.id, {
                            headers: {
                                "Authorization": localStorage.getItem("token")
                            }
                        }).then((response) => {
