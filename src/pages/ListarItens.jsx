...
const ListarItens = () => {
    ...
    const obterDados = async () => {
        const response = await axios.get("https://api.dev-diegodtsa.com.br/itens/" + restaurante_id, {
            headers: {
    ...
    const excluirItem = async (id) => {
        try {
            await axios.delete(`https://api.dev-diegodtsa.com.br/itens/${restaurante_id}/${id}`, {
                headers: {
                    "Authorization": localStorage.getItem("token")
                }
            })
                ...
                { itens.map((item) => 
                    ...
                    <Card sx={{ height: '460px' }}>
                        ...
                        <CardMedia
                            component="img"
                            height="200"
                            image={ "https://api.dev-diegodtsa.com.br/" + item.foto?.replace("public", "") }
                        />
                        <CardHeader
                            title={ item.nome }
