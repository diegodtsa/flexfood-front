...
const EditarItens = () => {
    ...
    const buscarDados = async () => {
        const response = await axios.get('https://api.dev-diegodtsa.com.br/itens/' + restaurante_id + '/' + item_id, {
            headers: {
    ...
    const enviarDados = async () => {
        ...
        try {
            const response = await axios.put('https://api.dev-diegodtsa.com.br/itens/' + restaurante_id + "/" + item_id,
                formData
            , {
                headers: {
                    "Authorization": localStorage.getItem("token"),
    ...
    <>
        ...
        <Container sx={{ mt: 10 }}>
            <Paper sx={{ p: 5 }}>
                ...
                <Box sx={{mb: 2}}>
                    <img src={"https://api.dev-diegodtsa.com.br/" + fotoAtual.replace("public", "")} height={100}/>
                </Box>
